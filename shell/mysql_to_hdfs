...
"cart_info")
  ...
  ;;
"comment_info")
  import_data /opt/module/datax/job/import/gmall.comment_info.json/user/hive/warehouse/gmall1.db/comment_info/$do_date
  ;;
"coupon_info")
...
"base_dic")
  ...
  ;;
"all")
  import_data /opt/module/datax/job/import/db_gmall.order_info.json /user/hive/warehouse/gmall1/order_info/$do_date
  import_data /opt/module/datax/job/import/db_gmall.base_category1.json/user/hive/warehouse/gmall1/base_category1/$do_date
  import_data /opt/module/datax/job/import/db_gmall.base_category2.json /user/hive/warehouse/gmall1/base_category2/$do_date
  import_data /opt/module/datax/job/import/db_gmall.base_category3.json /user/hive/warehouse/gmall1/base_category3/$do_date
  import_data /opt/module/datax/job/import/db_gmall.order_detail.json /user/hive/warehouse/gmall1/order_detail/$do_date
  import_data /opt/module/datax/job/import/db_gmall.sku_info.json /user/hive/warehouse/gmall1/sku_info/$do_date
  import_data /opt/module/datax/job/import/db_gmall.user_info.json /user/hive/warehouse/gmall1/user_info/$do_date
  import_data /opt/module/datax/job/import/db_gmall.payment_info.json/user/hive/warehouse/gmall1/payment_info/$do_date
  ;;
esac